...
import com.bytedance.club.dbhelper.FirstShelfSQLiteHelper;
import com.bytedance.club.dbhelper.SQLiteManager;
import com.bytedance.club.dbhelper.ShelfSQLiteHelper;
...
//            });
    ...
    private static void setPush(final Work work) {
        ...
        int wid = work.wid;
        work.push = "1";
        NetRequest.setWorkPushs(com.bytedance.club.publics.Constant.TWO, uid, wid, ONE,1, mToken, new OkHttpResult() {

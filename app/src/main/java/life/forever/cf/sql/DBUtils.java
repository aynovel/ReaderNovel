...
import life.forever.cf.entry.bean.AutoPayBookBeanDao;
import life.forever.cf.entry.BookMultiDownConfigBean;
import life.forever.cf.entry.bean.BookMultiDownConfigBeanDao;
import life.forever.cf.entry.BookRecordBean;
import life.forever.cf.entry.bean.BookRecordBeanDao;
import life.forever.cf.entry.BookUpdateTimeInfoBean;
import life.forever.cf.entry.bean.BookUpdateTimeInfoBeanDao;
import life.forever.cf.entry.ChapterItemBean;
import life.forever.cf.entry.bean.ChapterItemBeanDao;
import life.forever.cf.entry.bean.DaoSession;

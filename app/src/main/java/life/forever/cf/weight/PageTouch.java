...
public class PageTouch {
                                     ...
                                     int mDrawTopBottomMargin)
    {
        ...
        if (isScrollFlag) {
            ...
            Rect preFrame = new Rect(Constant.ZERO, Constant.ZERO, Constant.ZERO, Constant.ZERO);
...
//                destY = scollerRect.top - scollerRect.height();
            ...
            Rect mCurFrame = new Rect(Constant.ZERO, Constant.ZERO, Constant.ZERO, Constant.ZERO);
            if (mTempCurPage != null &&
            ...
            Rect mNextFrame = new Rect(Constant.ZERO, Constant.ZERO, Constant.ZERO, Constant.ZERO);
            if (mNextPage != null &&

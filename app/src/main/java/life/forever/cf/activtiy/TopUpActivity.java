...
import static life.forever.cf.activtiy.HomeActivity.contactList;
import static life.forever.cf.activtiy.HomeActivity.version_status;
...
import life.forever.cf.entry.TopUpListBean.ResultData;
...
//    protected aiyeWebWidget1 mWebView;
    ...
    private void loadUrl(TopUpListBean.ResultData.Info.Order_data mOrder) {
        ...
        String param = NetRequest.base64(jsonObject.toString());

...
public class MoreBuyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MoreBuyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_more, parent, Constant.FALSE));
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (HRMoreBuy != null) {
            if (HRMoreBuy.isclick) {
                ...
                viewHolder.tv_prace.setTextColor(Constant.application.getResources().getColor(R.color.theme_color));
            } else {
                viewHolder.rl_bg.setBackgroundResource(R.drawable.more_chapter_no_select);
                viewHolder.tv_prace.setTextColor(Constant.application.getResources().getColor(R.color.color_333333));
            }
            viewHolder.tv_prace.setText(HRMoreBuy.sum + " " + Constant.application.getString(R.string.topup_coins));
...
//            viewHolder.tv_prace.setText(HRMoreBuy.sum + " " + application.getString(R.string.topup_coins));
            ...
            if (position == mHRMoreBuy.size() - 1) {
                viewHolder.tv_chapters.setText(Constant.application.getString(R.string.remaining) + Constant.application.getString(R.string.chapters));
            } else {
                viewHolder.tv_chapters.setText(HRMoreBuy.count + " " + Constant.application.getString(R.string.chapters));
            }
        }

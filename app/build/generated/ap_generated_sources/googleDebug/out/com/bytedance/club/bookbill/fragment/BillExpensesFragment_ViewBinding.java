...
package com.bytedance.club.bookbill.fragment;
...
public class BillExpensesFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public BillExpensesFragment_ViewBinding(BillExpensesFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BillExpensesFragment target = this.target;

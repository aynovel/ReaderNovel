package com.bytedance.club.publics.picture;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.bytedance.club.publics.picture.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.bytedance.club.publics.picture.GlideOptions().apply(toSet));
    }
  }
}

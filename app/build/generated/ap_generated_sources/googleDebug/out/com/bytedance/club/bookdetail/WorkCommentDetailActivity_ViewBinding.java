...
public class WorkCommentDetailActivity_ViewBinding implements Unbinder {
  private WorkCommentDetailActivity target;
  ...
  @UiThread
  public WorkCommentDetailActivity_ViewBinding(WorkCommentDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public WorkCommentDetailActivity_ViewBinding(final WorkCommentDetailActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WorkCommentDetailActivity target = this.target;

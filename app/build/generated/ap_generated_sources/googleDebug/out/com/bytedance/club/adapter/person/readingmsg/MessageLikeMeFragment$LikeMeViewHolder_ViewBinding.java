...
public class MessageLikeMeFragment$LikeMeViewHolder_ViewBinding implements Unbinder {
  private MessageLikeMeFragment.LikeMeViewHolder target;

  @UiThread
  public MessageLikeMeFragment$LikeMeViewHolder_ViewBinding(
      MessageLikeMeFragment.LikeMeViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MessageLikeMeFragment.LikeMeViewHolder target = this.target;

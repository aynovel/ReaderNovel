...
public class ChapterUnlockActivity_ViewBinding implements Unbinder {
  private ChapterUnlockActivity target;

  @UiThread
  public ChapterUnlockActivity_ViewBinding(ChapterUnlockActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChapterUnlockActivity_ViewBinding(ChapterUnlockActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChapterUnlockActivity target = this.target;
